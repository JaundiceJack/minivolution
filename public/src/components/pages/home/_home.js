import CellWindow from './cellWindow.js';
    ...
    <div className="h-full flex xl:flex-row flex-col justify-center relative">
      ...
      <div className={`self-center bg-instructions w-80 sm:w-104 rounded-lg
        ...
        <h1 className={`font-bold bg-clip-text text-transparent text-2xl text-center
          ...
          MiniVolution</h1>
        <p className="text-white mb-4">This is an implementation of Conway's Game of Life.
        Click or hold shift to draw cells on the screen,
        then click start to watch them grow into complex patterns or die out.
        </p>
